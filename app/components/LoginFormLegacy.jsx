...
export default function LoginFormLegacy({ searchParams }) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <Link
          href="#!"
          className="text-amber-300 hover:text-amber-400 focus:text-amber-400 active:text-amber-500 duration-200 transition ease-in-out"
        >
          Forgot password?
        </Link>
      </div>
